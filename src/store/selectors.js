...
const decorateOrder = (order, tokens) => {
  ...
  tokenPrice = Number(tokenPrice).toFixed(4)


  return {
    ...order,
    token1Amount: Number(ethers.utils.formatUnits(token1Amount, "ether")).toFixed(4) ,
    token0Amount:Number(ethers.utils.formatUnits(token0Amount, "ether")).toFixed(4) ,
    tokenPrice,
